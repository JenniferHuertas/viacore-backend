...
export class CreateTrainingDto {
  @IsNotEmpty({
    message: 'El título de la capacitación es obligatorio',
  })
  @IsString({
  ...
  @IsNotEmpty({
    message: 'La breve descripción es obligatoria',
  })
  @IsString({
    message: 'La breve descripción debe ser un texto',
  })
  @Length(10, 120, {
  ...
  @IsNotEmpty({
    message: 'La descripción de la capacitación es obligatoria',
  })
  @IsString({
  ...
  @IsNotEmpty({
    message: 'El tagline es obligatorio',
  })
  @IsString({
    message: 'El tagline debe ser un texto',
  })
  @Length(10, 150, {
  ...
  @IsArray({
    message: 'Los includes deben ser un array',
  })
  @IsString({
    each: true,
    message: 'Cada include debe ser un texto',
  })
  @ApiProperty({
  ...
  @IsNotEmpty({
    message: 'La categoría de la capacitación es obligatoria',
  })
  @IsString({
  ...
  @IsOptional()
  @IsString({
    message: 'La URL de la imágen debe ser un texto',
  })
  @ApiProperty({
    description:
